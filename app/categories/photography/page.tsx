...
import { photographyTrends } from "@/lib/category-data"
...
export default function PhotographyPage() {
  ...
  const filteredTrends = selectedPlatform === "all" 
    ? photographyTrends 
    : photographyTrends.filter(trend => trend.platform === selectedPlatform)

  const platforms = ["all", ...Array.from(new Set(photographyTrends.map(trend => trend.platform)))]
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Top trending photography content</p>
        </div>
      </div>
