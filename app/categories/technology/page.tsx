...
import { technologyTrends } from "@/lib/category-data"
...
export default function TechnologyPage() {
  ...
  const filteredTrends = selectedPlatform === "all" 
    ? technologyTrends 
    : technologyTrends.filter(trend => trend.platform === selectedPlatform)

  const platforms = ["all", ...Array.from(new Set(technologyTrends.map(trend => trend.platform)))]
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Top trending technology content</p>
        </div>
      </div>
