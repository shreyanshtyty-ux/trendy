...
import { homeDecorTrends } from "@/lib/category-data"
...
export default function HomeDecorPage() {
  ...
  const filteredTrends = selectedPlatform === "all" 
    ? homeDecorTrends 
    : homeDecorTrends.filter(trend => trend.platform === selectedPlatform)

  const platforms = ["all", ...Array.from(new Set(homeDecorTrends.map(trend => trend.platform)))]
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Home & Décor</h1>
          <p className="text-muted-foreground">Top trending home decor and interior design</p>
        </div>
      </div>
