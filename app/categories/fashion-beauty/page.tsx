...
import { ArrowLeft, TrendingUp, Users, Share2, Heart } from "lucide-react"
import Link from "next/link"
import Image from "next/image"
import { fashionBeautyTrends } from "@/lib/category-data"
...
export default function FashionBeautyPage() {
  ...
  const filteredTrends = selectedPlatform === "all" 
    ? fashionBeautyTrends 
    : fashionBeautyTrends.filter(trend => trend.platform === selectedPlatform)

  const platforms = ["all", ...Array.from(new Set(fashionBeautyTrends.map(trend => trend.platform)))]
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Fashion & Beauty</h1>
          <p className="text-muted-foreground">Top trending fashion and beauty content</p>
        </div>
      </div>
